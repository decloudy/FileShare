        	...
        	<div class="modal-body">
        		<div class="tabbable" id="tabs-923579">
					<ul class="nav nav-tabs">
						<li  class="active"><a data-toggle="tab" href="#panel1">链接分享</a></li>
					...
					<div class="tab-content">
						...
						<label>是否创建链接？</label>
						<a href="#" type="button" class="btn btn-primary" style="">创建链接</a>
						</div>
...
/* $(function(){ 
	...
	$(".flieType li").click(<script type="text/javascript">
	(function(){
		var p = {
		url:location.href,
